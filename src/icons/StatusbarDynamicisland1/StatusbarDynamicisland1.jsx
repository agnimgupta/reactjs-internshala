...
export const StatusbarDynamicisland1 = ({ className }) => {
  return (
    <svg
      className={`statusbar-dynamicisland-1 ${className}`}
      fill="none"
      height="226"
      viewBox="0 0 393 226"
      width="393"
    ...
    >
      ...
      <g className="g" mask="url(#mask0_1_148)">
        <g className="g" filter="url(#filter0_bf_1_148)">
      ...
      <g className="g" filter="url(#filter1_d_1_148)">
      ...
      <defs className="defs">
        ...
        >
          ...
          <feComposite className="fe-composite" in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_1_148" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            ...
            result="shape"
          />
          <feGaussianBlur className="fe-gaussian-blur" result="effect2_foregroundBlur_1_148" stdDeviation="16" />
        </filter>
        <filter
          className="filter"
          colorInterpolationFilters="sRGB"
        ...
        >
          ...
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_1_148" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
